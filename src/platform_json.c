...
int platform_json_parse_null(platform_json_base_t **b, platform_json_parser_t *parser) {
  assert(parser);
...
int platform_json_parse_bool(platform_json_base_t **b, platform_json_parser_t *parser) {
  assert(parser);
  platform_json_parse_ws(parser);
...
int platform_json_parse_num(platform_json_base_t **b, platform_json_parser_t *parser) {
  assert(parser);
  platform_json_parse_ws(parser);
  int d;
