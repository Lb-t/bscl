...
int platform_os_sem_wait(platform_os_sem_t *sem) { return os_sem_timedwait(sem, INFINITE); }
int platform_os_sem_trywait(platform_os_sem_t *sem) { return os_sem_timedwait(sem, 0); }
