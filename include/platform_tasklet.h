...
struct platform_tasklet {
    ...
    volatile uint_fast32_t pend;
    volatile uint_fast32_t deal;
};
...
void platform_tasklet_head_init(struct platform_tasklet_head *th
        , platform_os_sem_t *sem, platform_os_mutex_t *mutex);
